...
(function (global, factory) {
   ...
   /*! *****************************************************************************
 Авторское право (c) корпорации Microsoft.

 Настоящим предоставляется разрешение на использование, копирование, модификацию и/или распространение данного программного обеспечения в любых
целях за плату или без нее.

 ПРОГРАММНОЕ ОБЕСПЕЧЕНИЕ ПРЕДОСТАВЛЯЕТСЯ "КАК ЕСТЬ", И АВТОР ОТКАЗЫВАЕТСЯ ОТ ВСЕХ ГАРАНТИЙ В
ОТНОШЕНИИ ЭТОГО ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ, ВКЛЮЧАЯ ВСЕ ПОДРАЗУМЕВАЕМЫЕ ГАРАНТИИ ТОВАРНОЙ ПРИГОДНОСТИ
 И ФИТНЕС. НИ В КОЕМ СЛУЧАЕ АВТОР НЕ НЕСЕТ ОТВЕТСТВЕННОСТИ ЗА КАКИЕ-ЛИБО ОСОБЫЕ, ПРЯМЫЕ,
КОСВЕННЫЕ ИЛИ ЛОГИЧЕСКИ ВЫТЕКАЮЩИЕ УБЫТКИ ИЛИ ЛЮБОЙ УЩЕРБ ВООБЩЕ, ВОЗНИКШИЙ В РЕЗУЛЬТАТЕ
 ПОТЕРЯ ИСПОЛЬЗОВАНИЯ, ДАННЫХ ИЛИ ПРИБЫЛИ, БУДЬ ТО В РЕЗУЛЬТАТЕ ДЕЙСТВИЯ КОНТРАКТА, ХАЛАТНОСТИ ИЛИ
ДРУГИХ НЕПРАВОМЕРНЫХ ДЕЙСТВИЙ, ВОЗНИКАЮЩИХ В РЕЗУЛЬТАТЕ ИЛИ В СВЯЗИ С ИСПОЛЬЗОВАНИЕМ ИЛИ
ПРОИЗВОДИТЕЛЬНОСТЬЮ ДАННОГО ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ.
 ***************************************************************************** */
 /* глобальное отражение, обещание */
